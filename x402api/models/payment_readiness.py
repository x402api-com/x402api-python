...
class PaymentReadiness(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.rails:
            ...
            _dict['rails'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in canonical_rails (list)
        _items = []
        if self.canonical_rails:
            for _item_canonical_rails in self.canonical_rails:
                if _item_canonical_rails:
                    _items.append(_item_canonical_rails.to_dict())
            _dict['canonical_rails'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "canonical_rails": [CanonicalPaymentReadinessRail.from_dict(_item) for _item in obj["canonical_rails"]] if obj.get("canonical_rails") is not None else None
        })
