...
class NetworkFeePreviewPrice(BaseModel):
    """
    NetworkFeePreviewPrice
    """ # noqa: E501
    asset_id: Annotated[str, Field(strict=True, max_length=80)]
    listed_amount_atomic: Annotated[str, Field(strict=True, max_length=78)]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["asset_id", "listed_amount_atomic"]
