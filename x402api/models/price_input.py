...
class PriceInput(BaseModel):
    ...
    max_timeout_seconds: Annotated[int, Field(le=3600, strict=True, ge=1)]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["asset_id", "wallet_version_id", "amount_atomic", "max_timeout_seconds"]
