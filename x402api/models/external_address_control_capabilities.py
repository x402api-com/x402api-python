...
class ExternalAddressControlCapabilities(BaseModel):
    """
    ExternalAddressControlCapabilities
    """ # noqa: E501
    networks: List[ExternalAddressControlCapability]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "networks": [ExternalAddressControlCapability.from_dict(_item) for _item in obj["networks"]] if obj.get("networks") is not None else None
        })
