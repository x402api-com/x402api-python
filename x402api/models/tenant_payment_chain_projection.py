...
class TenantPaymentChainProjection(BaseModel):
    """
    ...
    confirmations: Annotated[int, Field(strict=True, ge=0)]
    confirmations_required: Annotated[int, Field(strict=True, ge=0)]
    observed_at: Optional[datetime]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["state", "transaction_hash", "block_number", "block_hash", "confirmations", "confirmations_required", "observed_at"]
