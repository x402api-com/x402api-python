...
from x402api.configuration import Configuration
from x402api.api_response import ApiResponse, T as ApiResponseT
import x402api.models
from x402api import rest
from x402api.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(x402api.models, klass)
