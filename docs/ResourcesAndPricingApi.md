...
[**resources_activate_version**](ResourcesAndPricingApi.md#resources_activate_version) | **POST** /v1/resources/{resource_id}/versions/{version_id}/activate | Activate a resource version
...
[**resources_retire_version**](ResourcesAndPricingApi.md#resources_retire_version) | **POST** /v1/resources/{resource_id}/versions/{version_id}/retire | Retire a resource version
...
# **resources_activate_version**
> ResourceVersion resources_activate_version(idempotency_key, resource_id, version_id, resource_version_activate)
...
with x402api.ApiClient(configuration) as api_client:
    ...
    try:
        # Activate a resource version
        api_response = api_instance.resources_activate_version(idempotency_key, resource_id, version_id, resource_version_activate)
        print("The response of ResourcesAndPricingApi->resources_activate_version:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ResourcesAndPricingApi->resources_activate_version: %s\n" % e)
```
...
# **resources_retire_version**
> ResourceVersion resources_retire_version(idempotency_key, resource_id, version_id, resource_version_retire)
...
with x402api.ApiClient(configuration) as api_client:
    ...
    try:
        # Retire a resource version
        api_response = api_instance.resources_retire_version(idempotency_key, resource_id, version_id, resource_version_retire)
        print("The response of ResourcesAndPricingApi->resources_retire_version:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ResourcesAndPricingApi->resources_retire_version: %s\n" % e)
```
